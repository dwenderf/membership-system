...
/**
 * Debug script to test Xero contact search strategy
 * 
 * This script helps debug contact search issues by:
 * 1. Testing the exact name search first
 * 2. Falling back to email search
 * 3. Showing all contacts found with detailed information
 * 
 * Usage: 
 * 1. Save this as an API route: src/app/api/debug-xero-contacts/route.js
 * 2. Call: GET /api/debug-xero-contacts?email=david@example.com&memberId=1002
 */

// This is a template for creating an API route
// Copy this content to: src/app/api/debug-xero-contacts/route.js
...
console.log('🔍 Xero Contact Search Debug Script')
console.log('====================================')
console.log('')
console.log('To use this debug script:')
console.log('')
console.log('1. Create a new API route file:')
console.log('   src/app/api/debug-xero-contacts/route.js')
console.log('')
console.log('2. Copy the commented code above into that file')
console.log('')
console.log('3. Call the API endpoint:')
console.log('   GET /api/debug-xero-contacts?email=david@example.com&memberId=1002')
console.log('')
console.log('This will show you:')
console.log('- What contacts are found by exact name search')
console.log('- What contacts are found by email search')
console.log('- Which contact would be selected')
console.log('- Whether any contacts are archived')
console.log('')
console.log('The API will return JSON with detailed contact information.') 
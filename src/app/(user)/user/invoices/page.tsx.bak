...
import { formatAmount, getInvoiceDueDate, isInvoiceOverdue, getDaysUntilDue } from '@/lib/format-utils'
                          ...
                          <div className="ml-4">
                            ...
                            <div className="text-sm text-gray-500">
                              ...
                              {invoice.total > 0 && isPaid && invoice.latestPaymentDate ? (
                                <span className="ml-2">
                                  • Paid: {new Date(invoice.latestPaymentDate).toLocaleDateString()}
                                </span>

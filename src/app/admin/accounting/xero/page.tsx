...
function XeroIntegrationContent() {
  ...
  const fetchXeroStatus = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Just get pending count for summary
  ...
  }, [searchParams, router, showError, showSuccess, fetchXeroStatus])
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Manage your Xero accounting integration and connection settings
        </p>
      </div>
      ...
      <div className="space-y-6">
              ...
              {pendingSyncCount > 0 && (
                <div className="p-3 bg-orange-50 border border-orange-200 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div className="flex-1">
                      <h3 className="text-sm font-medium text-orange-800">Sync Status</h3>
                      <p className="text-sm text-orange-700">
                        {pendingSyncCount} items pending sync to Xero
                      </p>
                    </div>
                    <Link
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Connection Management</h2>
          ...
          <div className="flex justify-center">
            {isXeroConnected ? (
              <button 
                ...
                className="inline-flex items-center px-6 py-3 border border-red-300 rounded-lg text-sm font-medium text-red-700 bg-red-50 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    {disconnecting ? (
                      <svg className="animate-spin h-5 w-5 text-red-400 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-red-600">
                      {disconnecting ? 'Please wait...' : 'This will stop automatic syncing'}
                    </div>
                  </div>
                </div>
              </button>
              ...
              <Link
                ...
                className="inline-flex items-center px-6 py-3 border border-blue-300 rounded-lg text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div>
                    <div className="text-blue-900 font-medium">Connect to Xero</div>
                    <div className="text-xs text-blue-600">Set up automatic invoice and payment syncing</div>
                  </div>
                </div>
              </Link>
            )}

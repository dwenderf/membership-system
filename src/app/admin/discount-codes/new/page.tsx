            ...
            <form onSubmit={handleSubmit} className="space-y-6 p-6">
              ...
              {selectedCategory && (
                <div className="bg-gray-50 border border-gray-200 rounded-md p-4">
                  <h4 className="text-sm font-medium text-gray-900 mb-2">Category Details</h4>
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2">
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Accounting Code</dt>
                      <dd className="text-sm text-gray-900">{selectedCategory.accounting_code}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Spending Limit</dt>
                      <dd className="text-sm text-gray-900">
                        {selectedCategory.max_discount_per_user_per_season 
                          ? `$${(selectedCategory.max_discount_per_user_per_season / 100).toFixed(2)} per user per season`
                          : 'No limit'
                        }
                      </dd>
                    </div>

-- Create a comprehensive view for membership analytics (current members and their details)
-- This view handles all the complex logic for getting the latest membership per user
...
COMMENT ON VIEW membership_analytics_data IS 'Comprehensive view for membership analytics with calculated statistics and member details';
